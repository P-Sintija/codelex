...
echo "Total deposited: $" . number_format($account->getTotalDeposit() / 100, 2, '.', ',') . PHP_EOL;
echo "Total withdrawn: $" . number_format($account->getTotalWithdraw() / 100, 2, '.', ',') . PHP_EOL;
echo "Interest earned: $" . number_format($account->getInterestEarned()/ 100, 2, '.', ',') . PHP_EOL;
echo "Ending balance: $" . number_format($account->getBalance() / 100, 2, '.', ',') . PHP_EOL;
